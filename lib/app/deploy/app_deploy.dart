class AppDeploy {
  ...
  // 新建 mask
  static String designMask = '/userProfile/add';
  ...
  //支持的语言
  static String supportLang = '/translate/languages';

  static const String undressStyle = '/getStyleConfig';
  static const String getUndressHistory = "/noDressHis/getAll";
  static const String getUndressResult = "/v2/getUndressWithResult";
  static const String getUndressVideoResult = "/getUndressWithVideoResult";

  // undress role/img
  static const String undressImg = '/v2/getUndressWith';
  static const String undressVideo = '/getUndressWithVideo';

  /// Home create images
  static const String getCreationStyleOptions = "/creationStyleOptions/getAll";
  static const String getPresetPrompt = "/aiPhoto/gems/getPresetPrompt";
  static const String genAiPhoto = "/aiPhoto/gems/gen";
  static const String aiPhotoHistory="/aiPhoto/history";
  static const String getGenImg="/aiPhoto/gems/getGenImg";
}
