...
class KanimGradProgress extends StatefulWidget {
  ...
  const KanimGradProgress({
    super.key,
    required this.progress,
    this.width = 250,
    this.height = 6,
    this.gradientColors = Theme1.gradients, // 默认渐变色
    this.trackColor = Colors.white, // 默认轨道颜色
  ...
  @override
  State<KanimGradProgress> createState() => _KanimGradProgressState();
}

class _KanimGradProgressState extends State<KanimGradProgress> {
  ...
  @override
  void didUpdateWidget(covariant KanimGradProgress oldWidget) {
